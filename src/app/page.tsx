    ...
    <main className="min-h-screen relative flex justify-center overflow-x-hidden font-sans text-neutral-100 bg-[#0d0d0d]">
      ...
      <div className="w-full max-w-[480px] px-5 py-12 pb-8 relative z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 animate-fade-in-up delay-600">
          ...
          <a href="#evento" className="relative w-full h-[320px] rounded-3xl overflow-hidden group border border-white/5 block active:scale-[0.98] transition-transform shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
              <div>
                ...
                <p className="text-neutral-300 text-sm mt-2 max-w-[95%] leading-relaxed">Viva uma experiência prática intensa. Garanta sua vaga no próximo evento.</p>
              </div>
          ...
          {/* Cursos Link */}
          <a href="#cursos" className="relative w-full h-[320px] rounded-3xl overflow-hidden group border border-white/5 block active:scale-[0.98] transition-transform shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
              <div>
                ...
                <p className="text-neutral-300 text-sm mt-2 max-w-[95%] leading-relaxed">Aprenda no seu ritmo. Acesse o Portal do Aluno para começar agora.</p>
              </div>
